        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="pt-3 px-3">
                            <form class="form form-horizontal" action="{{ URL('/edit-profil-guru/') }}" method="POST"
                                    ...
                                    @endif --}}
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input class="form-control @error('foto') is-invalid @enderror" type="file"
                                                id="foto" name="foto" value="{{ $data->foto }}"
                                        ...
                                        <div class="col-md-9 form-group">
                                            <fieldset class="form-group">
                                                <select class="form-select" id="basicSelect" name="jenis_kelamin">
                                                    <option value="LK"
                                                        @if ($data->jenis_kelamin == 'LK') selected @endif>Laki-Laki</option>
                                                    <option value="PR"
                                                        @if ($data->jenis_kelamin == 'PR') selected @endif>Perempuan</option>
                                                </select>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="alamat_tinggal" class="form-control"
                                                name="alamat_tinggal" value="{{ $data->alamat_tinggal }}" placeholder="-">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="alamat_domisili" class="form-control"
                                                name="alamat_domisili" value="{{ $data->alamat_domisili }}"
                                                placeholder="-">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="year" id="tahun" class="form-control"
                                                name="tahun_ijazah" value="{{ $data->tahun_ijazah }}" placeholder="-">
                                        </div>
                                        <div class="col-md-3">
                                            <label>Status</label>
                                        </div>
                                        <div class="col-md-9 mb-1 form-group">
                                            <fieldset class="form-group">
                                                <select class="form-select" id="basicSelect" name="status_perkawinan">
                                                    <option value="Kawin"
                                                        @if ($data->status_perkawinan == 'Kawin') selected @endif>Menikah</option>
                                                    <option value="Tidak Kawin"
                                                        @if ($data->status_perkawinan == 'Belum Kawin') selected @endif>Belum Menikah
                                                    </option>
                                                </select>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="tglmsk" class="form-control"
                                                name="tanggal_masuk" value="{{ $data->tanggal_masuk }}" placeholder="-"
                                                disabled>
                                        </div>
                                        <div class="form-group  px-3 pt-2 modal-footer">
                                            ...
                                            <button id="success" type="submit"
                                                class="btn icon icon-left btn-success px-3"><i
