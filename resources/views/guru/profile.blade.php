                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="pt-3 text-center">
                            @if ($gurus->foto)
                                <img src="{{ asset('storage/' . $gurus->foto) }}" class="rounded" alt="..."
                                    width="220">
                            @else
                                <img class="rounded">
                            @endif
                                    ...
                                    <div class="row" id="{{ $gurus->user }}">
                                        ...
                                        <div class="col-md-9 form-group">
                                            @if ($gurus->jenis_kelamin == 'LK')
                                                <input type="text" id="jenis_kelamin" class="form-control"
                                                    name="jenis_kelamin" value="Laki-Laki" placeholder="Jenis Kelamin"
                                                    readonly>
                                            @else
                                                <input type="text" id="jenis_kelamin" class="form-control"
                                                    name="jenis_kelamin" value="Perempuan" placeholder="Jenis Kelamin"
                                                    readonly>
                                            @endif
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="alamat_tinggal" class="form-control"
                                                name="alamat_tinggal" value="{{ $gurus->alamat_tinggal }}" placeholder="-"
                                                readonly>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 form-group">
                                            <input type="text" id="alamat_domisili" class="form-control"
                                                name="alamat_domisili" value="{{ $gurus->alamat_domisili }}"
