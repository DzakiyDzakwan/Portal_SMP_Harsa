    ...
    <div class="col-12 col-lg-4 col-md-6">
        <div class="card">
            <div class="card-body px-4 py-4-5">
                <div class="row">
                    <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-center md-justify-content-start">
...
<ul class="nav nav-tabs justify-content-start align-items-center my-3" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="nav-link active" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Mata Pelajaran</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link" id="profilePribadi-tab" data-bs-toggle="tab" href="#profilePribadi" role="tab" aria-controls="profilePribadi" aria-selected="false">Mapel Guru</a>
    </li>
</ul>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="modal-warning me-1 mb-1 d-inline-block">
                                    <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#update{{ $loop->iteration }}" data-order=>
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                </div>
                                {{-- Delete Button --}}
                                <div class="modal-danger me-1 mb-1 d-inline-block">
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{ $loop->iteration }}">
...
@foreach ($mapel as $pel)
{{-- Modal edit --}}
<div class="modal fade text-left" id="update{{ $loop->iteration }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel130" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/mapel/updateMapel/{{ $pel->mapel_id }}" method="post">
                    ...
                    <div class="modal-body">
                        <label>Kode Mata Pelajaran: </label>
                        <div class="form-group">
                            <input name="mapel_id" value="{{ $pel->mapel_id }}" type="text" class="form-control" />
                        </div>
                        <label>Nama Mata Pelajaran: </label>
                        <div class="form-group">
                            <input name="nama_mapel" value="{{ $pel->nama_mapel }}" type="text" class="form-control" />
                        </div>
                        <label>Kelompok Mata Pelajaran: </label>
                        <div class="form-group">
                            <select value="{{ $pel->kelompok_mapel }}" class="form-control" id="exampleFormControlSelect1" name="kelompok_mapel">
                                <option value="A">A</option>
                                <option value="B">B</option>
                            </select>
                        </div>
                        <label>Kurikulum: </label>
                        <div class="form-group">
                            <input name="kurikulum" value="{{ $pel->kurikulum }}" type="text" class="form-control" />
                        </div>
                    </div>
...
{{-- Modal Delete --}}
<div class="modal fade text-left" id="delete{{ $loop->iteration }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel130" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
