                        ...
                        <td>
                            ...
                            <div class="modal-warning me-1 mb-1 d-inline-block">
                                <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#update{{ $e->ekskul_id }}" data-order=>
                            ...
                            <div class="modal-danger me-1 mb-1 d-inline-block">
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#delete{{ $e->ekskul_id }}">
...
>
    ...
    >
        <div class="modal-content">
            ...
            <form class="form form-vertical" action="/ekskul/updateEkskul/{{ $e->ekskul_id }}" method="POST">
                @csrf
                <div class="form-body modal-body">
                    <div class="row">
                        {{-- ID Ekstrakulikuler --}}
...
>
    ...
    >
        <div class="modal-content">
            ...
            <div class="modal-body">Apakah yakin menghapus data ekrttakurikuler {{ $e->nama }}?</div>
            <div class="modal-footer">
                ...
                <form action="/ekskul/deleteEkskul/{{ $e->ekskul_id }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button
