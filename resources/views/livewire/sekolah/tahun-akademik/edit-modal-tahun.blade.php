    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning justify-content-center">
                <h4 class="modal-title white " id="myModalLabel33">Ubah Tahun Ajaran</h4>
            </div>
                ...
                <div class="form-body modal-body">
                    <div class="row">
                            ...
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <select name="semester"
                                        ...
                                        id="basicSelect" wire:model.defer="semester" disabled>
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <button type="submit" class="btn btn-sm btn-warning me-1 mb-1">
                                Ubah
                            </button>
                        </div>
                    </div>
