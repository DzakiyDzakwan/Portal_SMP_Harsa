...
<body>
    @foreach ($kelas as $item)
        <h3 align="center">JADWAL MATA PELAJARAN KELAS <span
                style="text-transform:uppercase;">{{ $kelas->nama_kelas_aktif }}</span> <br> SMP HARAPAN 1 MEDAN <br>
            TAHUN PELAJARAN {{ $ta }}</h3>
    @endforeach
    <br>
    <table class="table">
        <thead>
