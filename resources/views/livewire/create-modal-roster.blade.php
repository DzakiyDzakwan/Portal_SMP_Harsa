                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <select name="mapel" class="form-select form-control" id="basicSelect" wire:model.defer="mapel">
                                            <option>Pilih mata pelajaran</option>
                                            @foreach ($mapels as $m)
                                                <option value="{{ $m->mapel_guru_id }}">{{ $m->mapel }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <select name="kelas" class="form-select form-control" id="basicSelect" wire:model.defer="kelas">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                            <select name="hari" class="form-select form-control" id="basicSelect" wire:model.defer="hari">
