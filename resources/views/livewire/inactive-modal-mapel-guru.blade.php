<div>
    ...
    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#inactiveModal">
        <i class="bi bi-person-workspace"></i> Inactive Mata Pelajaran Guru
    </button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger justify-content-center">
                    <h4 class="modal-title white " id="myModalLabel33">Inactive Mata Pelajaran Guru</h4>
                </div>
                <div class="modal-body">
                    @livewire('list-inactive-mapel-guru')
                </div>
