<div class="toast-container position-fixed top-0 end-0 p-3">
    ...
    <div id="inactiveToast" class="toast align-items-center  text-bg-danger" role="alert" aria-live="assertive"
        ...
        <div class="d-flex">
            <div class="toast-body">
                Ekstrakurikuler Berhasil di Non Aktifkan
            </div>
            <button type="button" class="btn-close me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
        </div>
    </div>
    ...
    {{-- Restore Pembina --}}
    <div id="restoreToast" class="toast align-items-center  text-bg-danger" role="alert" aria-live="assertive"
        aria-atomic="true">
        <div class="d-flex">
            <div class="toast-body">
                Pembina berhasil dihapus dari Ekstrakulikuler
            </div>
            <button type="button" class="btn-close me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
        </div>
    </div>
    ...
    <div id="deleteToast" class="toast align-items-center  text-bg-danger" role="alert" aria-live="assertive"
        ...
        <div class="d-flex">
            <div class="toast-body">
                Siswa berhasil dihapus dari Ekstrakulikuler
            </div>
            <button type="button" class="btn-close me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
        </div>
    </div>
