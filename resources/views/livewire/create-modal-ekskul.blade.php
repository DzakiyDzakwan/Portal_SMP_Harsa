                    ...
                    <div class="row">
                            ...
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <input
                                        name="ekskul_id"
                                        type="text"
                                        class="form-control @error('ekstrakurikuler_id') is-invalid
                                        @enderror"
                                        placeholder="Masukkan ID Ekstrakulikuler"
                                        id="ekskul_id"
                                        wire:model.defer="ekstrakurikuler_id"
                                    />
                        ...
                        <div class="col-4">
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                        <select name="hari" class="form-select form-control @error('hari') is-invalid
                                        @enderror" id="basicSelect" wire:model.defer="hari">
                        ...
                        <div class="col-12">
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <select name="kelas" class="form-select form-control @error('kelas') is-invalid
                                    @enderror" id="basicSelect" wire:model.defer="kelas">
