            ...
            <div class="card-body px-4 py-4-5">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7 text-center md-text-start">
                        ...
                        <h6 class="font-extrabold mb-0">{{$siswaLulus}}</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body px-4 py-4-5">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7 text-center md-text-start">
                        <h6 class="text-muted font-semibold">Pindah</h6>
                        <h6 class="font-extrabold mb-0">{{$siswaPindah}}</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body px-4 py-4-5">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7 text-center md-text-start">
                        <h6 class="text-muted font-semibold">Drop Out</h6>
                        <h6 class="font-extrabold mb-0">{{$siswaDO}}</h6>
                    </div>
                </div>
            </div>
        </div>
