                        ...
                        <div class="row">
                                ...
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror "
                                            placeholder="Nama" id="first-name-icon" wire:model.defer="nama" />
                                ...
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input name="nisn" type="text" class="form-control @error('nisn') is-invalid @enderror "
                                            placeholder="NISN" id="password-id-icon" wire:model.defer="nisn" />
                                        <div class="form-control-icon">
                                ...
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input name="NIS" type="text" class="form-control @error('nis') is-invalid @enderror "
                                            placeholder="NIS" id="password-id-icon" wire:model.defer="nis" />
                                        <div class="form-control-icon">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input name="tanggal_masuk" type="date" class="form-control @error('tanggal_masuk') is-invalid @enderror "
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <select name="kelas_id" class="form-select form-control  @error('kelas_id') is-invalid
                                        @enderror" id="basicSelect" wire:model.defer="kelas_id">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <select name="jenis_kelamin" class="form-select form-control  @error('jenis_kelamin') is-invalid
                                        @enderror" id="basicSelect" wire:model.defer="jenis_kelamin">
