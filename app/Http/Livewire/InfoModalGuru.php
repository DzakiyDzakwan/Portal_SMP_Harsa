...
{
   public $nama, $nip, $jabatan, $jenis_kelamin, $tgl_masuk, $status, $pendidikan, $tahun_ijazah, $status_perkawinan, $alamat_tinggal, $alamat_domisili, $tempat_lahir, $tgl_lahir;
    ...
    {
        return view('admin.components.livewire.info-modal-guru');
    }

    public function showModal($id) {
        $data = User::join('gurus', 'users.uuid', '=', 'gurus.user')->join('user_profiles', 'user_profiles.user', '=', 'users.uuid')->where('users.uuid', $id)->first();
        $this->nama = $data->nama;
        $this->nip = $data->NIP;
