...
return new class extends Migration
{
        ...
        public function up()
        {
                ...
                DB::unprepared('
                        ...
                        FOR EACH ROW
                        BEGIN
                                INSERT INTO log_ekstrakurikulers (ekstrakurikuler_id, nama, hari, waktu_mulai, waktu_akhir, tempat, kelas, action, created_at)
                                VALUES (NEW.ekstrakurikuler_id, NEW.nama, NEW.hari, NEW.waktu_mulai, NEW.waktu_akhir, NEW.tempat, NEW.kelas, "insert", NOW());
                        END
                ');
                ...
                DB::unprepared('
                        ...
                        BEGIN
                                INSERT INTO log_ekstrakurikulers (ekstrakurikuler_id, nama, hari, waktu_mulai, waktu_akhir, tempat, kelas, action, created_at)
                                VALUES (NEW.ekstrakurikuler_id, NEW.nama, NEW.hari, NEW.waktu_mulai, NEW.waktu_akhir, NEW.tempat, NEW.kelas, "update", NOW());
                        END
                ');
                ...
                BEGIN
                        INSERT INTO log_ekstrakurikulers (ekstrakurikuler_id, nama, hari, waktu_mulai, waktu_akhir, tempat, kelas, action, created_at)
                        VALUES (OLD.ekstrakurikuler_id, OLD.nama, OLD.hari, OLD.waktu_mulai, OLD.waktu_akhir, OLD.tempat, OLD.kelas, "delete", NOW());
                END
                ');
