...
Route::group(['middleware' => ['auth', 'isGuru', 'role:guru|kepsek|wakepsek|admin|wali|pembina']], function () {
    ...
    Route::get('/edit-profil-guru', [ProfilController::class, 'editProfilGuru'])->name('editProfilGuru');
    Route::get('/password-guru', [ProfilController::class, 'passwordGuru'])->name('passwordGuru');
    ...
    Route::group(['middleware' => ['role:kepsek|wakepsek|admin']], function () {
        ...
        Route::get('/guru/roster/{ta}/{sem}/{kls}/cetak', [ReportController::class, 'exportRoster'])->name('export-roster');
        Route::get('/guru/ekstrakurikuler/cetak', [ReportController::class, 'exportEkskul'])->name('export-ekskul');
    });
